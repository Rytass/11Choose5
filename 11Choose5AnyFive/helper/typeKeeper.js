  ...
  const result = [
    ...
    ...numbers.filter((num) => {
      if (options.bigTypeFour) {
        return (
          getTargetArray(num).filter(target => target.match(/[7890E]/)).length === 4
        );
      }
    ...
    ...numbers.filter((num) => {
      if (options.bigTypeFive) {
        return (
          getTargetArray(num).filter(target => target.match(/[7890E]/)).length === 5
        );
      }
  ...
  const result = [
    ...
    ...numbers.filter((num) => {
      if (options.oddTypeFour) {
        return (
          getTargetArray(num).filter(target => target.match(/[13579E]/)).length === 4
        );
      }
    ...
    ...numbers.filter((num) => {
      if (options.oddTypeFive) {
        return (
          getTargetArray(num).filter(target => target.match(/[13579E]/)).length === 5
        );
      }
  ...
  const result = [
    ...
    ...numbers.filter((num) => {
      if (options.primeTypeFour) {
        return (
          getTargetArray(num).filter(target => target.match(/[12357E]/)).length === 4
        );
      }
    ...
    ...numbers.filter((num) => {
      if (options.primeTypeFive) {
        return (
          getTargetArray(num).filter(target => target.match(/[12357E]/)).length === 5
        );
      }
...
export function twoLoadTypeKeeper(numbers, options) {
  ...
  const result = [
    ...
    ...numbers.filter((num) => {
      if (options.twoLoadTypeFour) {
        return (
          getTargetArray(num).filter(target => target.match(/[258E]/)).length === 4
        );
      }
