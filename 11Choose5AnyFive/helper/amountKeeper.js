      ...
      if (options.bigNumberFour) {
        return (
          [
            ...
            parseNumber(num.num[3]),
            parseNumber(num.num[4]),
          ].filter(n => n > bigDefinition).length === 4
        );
      }
      ...
      if (options.bigNumberFive) {
        return (
          [
            ...
            parseNumber(num.num[3]),
            parseNumber(num.num[4]),
          ].filter(n => n > bigDefinition).length === 5
        );
      }
      ...
      if (options.oddNumberFour) {
        return (
          [
            ...
            num.num[3],
            num.num[4],
          ].filter(n => n.match(/[13579E]/)).length === 4
        );
      }
      ...
      if (options.oddNumberFive) {
        return (
          [
            ...
            num.num[3],
            num.num[4],
          ].filter(n => n.match(/[13579E]/)).length === 5
        );
      }
...
export function primeNumberKeeper(numbers, options) {
  const composed = Object.entries(options)
    .filter(entry => entry[0].match(/primeNumber/) && entry[1] === true);

  if (!composed.length) return numbers;

  const result = [
    ...numbers.filter((num) => {
      if (options.primeNumberZero) {
        return (
          [
            num.num[0],
            num.num[1],
            ...
            num.num[3],
            num.num[4],
          ].filter(n => n.match(/[12357E]/)).length === 0
        );
      }
      ...
      if (options.primeNumberOne) {
        return (
          [
            ...
            num.num[3],
            num.num[4],
          ].filter(n => n.match(/[12357E]/)).length === 1
        );
      }
      ...
      if (options.primeNumberTwo) {
        return (
          [
            ...
            num.num[3],
            num.num[4],
          ].filter(n => n.match(/[12357E]/)).length === 2
        );
      }
      ...
      if (options.primeNumberThree) {
        return (
          [
            ...
            num.num[3],
            num.num[4],
          ].filter(n => n.match(/[12357E]/)).length === 3
        );
      }
      ...
      if (options.primeNumberFour) {
        return (
          [
            ...
            num.num[3],
            num.num[4],
          ].filter(n => n.match(/[12357E]/)).length === 4
        );
      }
      ...
      if (options.primeNumberFive) {
        return (
          [
            ...
            num.num[3],
            num.num[4],
          ].filter(n => n.match(/[12357E]/)).length === 5
        );
      }
